...
export const metadata: Metadata = {
  title: "Terms of Service — Orbit Frame",
  description:
    "Read the Terms of Service for Orbit Frame. By using our website, you agree to these terms governing your use of the site and services.",
};
      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-8 text-[#8BA3BE] leading-relaxed">
          <section>
            ...
            <p>
              By accessing or using the Orbit Frame website (the "Site"), you agree to be
          ...
          <section>
            ...
            <p>
              Orbit Frame is a curated directory platform that provides information,
              comparisons, reviews, and pricing details about design and creative software tools. Our platform serves as a research and discovery resource. We do not
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              content              — are owned by Orbit Frame and are protected by international
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              of Orbit Frame. We reserve the right to moderate, edit, or remove reviews
          ...
          <section>
            ...
            <p>
              ...
              controlled by Orbit Frame. We have no control over, and assume no
          ...
          <section>
            ...
            <p>
              Orbit Frame offers free access to our directory and comparison features.
          ...
          <section>
            ...
            <p>
              To the fullest extent permitted by law, Orbit Frame, its officers, directors,
          ...
          <section>
            ...
            <p>
              You agree to indemnify, defend, and hold harmless Orbit Frame and its
          ...
          <section>
            ...
            <div className="mt-4 p-5 bg-[#0F1D32] border border-[#1E3A5F] rounded-xl">
              <p className="mb-2"><strong className="text-[#F0F4F8]">Email:</strong> legal@orbitframe.design</p>
              <p className="mb-2"><strong className="text-[#F0F4F8]">Support:</strong> hello@orbitframe.design</p>
              <p><strong className="text-[#F0F4F8]">Address:</strong> Wycker Brugstraat 28, 6221 EC Maastricht, Netherlands</p>
            </div>
          </section>
        </div>
      </div>
